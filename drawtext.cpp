...
void draw_text(bool i_black, unsigned short i_x, unsigned short i_y, const std::string& i_text, sf::RenderWindow& i_window, sf::Color text_color)
{
	...
	character_sprite.setColor(text_color);
